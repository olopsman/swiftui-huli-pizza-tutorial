...
//        Alert(title: "Pizza", message: Text("You ordered a " + self.menuItem.name))
//    }
    ...
    var body: some View {
        VStack {
            ...
            Spacer()
            Picker(selection: $settings.size, label: Text("Pizza Size"), content: {
...
//                .alert(isPresented: $didOrder) {  Alert(title: Text("Your Pizza"), message: Text("You ordered a " + self.menuItem.name))
//                }
